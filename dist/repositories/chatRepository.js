...
class ChatRepositoryImplementation {
    ...
    findChatByUsers(user1Id, user2Id) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const chat = yield newChat_1.Chat.findOne({
                $or: [
                    { user1Id, user2Id },
    ...
    updateChatTimestamp(chatId) {
        return __awaiter(this, void 0, void 0, function* () {
            yield newChat_1.Chat.findByIdAndUpdate(chatId, { updatedAt: new Date() });
        });
    }
    getUserChats(userId) {
        return __awaiter(this, void 0, void 0, function* () {
            console.log('getUserChats, impl');
            const chats = yield newChat_1.Chat.aggregate([
                {
                    $match: {
                        $or: [
                            { user1Id: userId },
